...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>Admin Login - Secret Seven</title>
					...
					<div class="col-md-8 col-xl-6 mx-auto">
						<div class="card">
							<div class="row">
                                                                ...
                                                                <a href="#" class="noble-ui-logo logo-light d-block mb-2">Secret<span>Seven</span></a>
                                                                ...
                                                                <form class="forms-sample" method="POST" action="{{route('login')}}">
                                                                        ...
                                                                        <div class="mb-3">
                                                                                ...
                                                                                <input type="password" class="form-control" id="password" name="password" autocomplete="current-password" required placeholder="Password">
                                                                        </div>
